"""Rerun an existing server-side reduction while reusing its retained WSClean model."""
import os, re, sys, shutil, tarfile, glob
import pandas as pd
...
from science_utils import extract_sbid_and_beam, run_cmd  # noqa: E402
...
def main() -> None:
    ...
    for tar_path in tar_paths:
        try:
            # 单 tar 重跑逻辑直接内联在批处理 try 块中，保持异常逐文件隔离。
