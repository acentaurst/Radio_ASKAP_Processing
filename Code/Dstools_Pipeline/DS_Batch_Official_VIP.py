"""Run the priority/VIP server-side ASKAP-to-DS reduction for selected archives."""
...
INPUT_CSV = PROJECT_ROOT / "Processed_Data" / "Catalogue" / "02.final_confirmed_stars_direct_1.csv"
...
# --- 核心数据处理逻辑 (与主程序完全一致) ---
# --- 核心数据处理与 VIP 调度（单包逻辑保留在 executor 回调中） ---
def main() -> None:
    logging.basicConfig(
        level=logging.INFO,
